...
ironman = media.Movie("Iron Man 3",
    ...
    "https://images-na.ssl-images-amazon.com/images/M/MV5BMTkzMjEzMjY1M15BMl5BanBnXkFtZTcwNTMxOTYyOQ@@._V1_UY268_CR3,0,182,268_AL_.jpg",
    "https://www.youtube.com/watch?v=aV8H7kszXqo"
)
movies.append(ironman)

captain = media.Movie("Captain America: Civil War",
...
strange = media.Movie("Doctor Strange",
    ...
    "http://vignette2.wikia.nocookie.net/marvelcinematicuniverse/images/a/a4/DS_Endless_Possibilities_Poster.jpg/revision/latest?cb=20160909202223",
